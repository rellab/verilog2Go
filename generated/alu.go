...
alu := &Alu{variable.NewBitArray(2), variable.NewBitArray(2), variable.NewBitArray(5), variable.NewBitArray(2), variable.NewBitArray(2), variable.NewBitArray(2)}
go alu.run(in, out)
return alu
}
...
alu.y.Assign(variable.CreateBitArray(16, 0).Add(*alu.b))
}
...
var1 := *variable.CreateBitArray(2, Alu.a.ToInt())
var2 := *variable.CreateBitArray(2, Alu.b.ToInt())
