...
conditional_statement
   : 'if' '(' expression ')' statement_or_null (else_statement statement_or_null)?
   | if_else_if_statement
   ;

if_else_if_statement
   : 'if' '(' expression ')' statement_or_null (else_statement 'if' '(' expression ')' statement_or_null)* (else_statement statement_or_null)?
   ;
...
function_conditional_statement
   : 'if' '(' expression ')' function_statement_or_null (else_statement function_statement_or_null)?
